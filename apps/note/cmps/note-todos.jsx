...
export class NoteTodos extends React.Component {
    ...
    render() {
        ...
        const { note, todos, colorPalleteOpened } = this.state
        const { removeTodo, handleColorPallete , handleColorChange } = this

        return <div className="note-todos flex column space-between">
